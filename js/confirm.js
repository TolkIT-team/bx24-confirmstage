BX.ready(() => {
    const originalOnStageChange = BX.Crm?.ItemDetailsComponent?.prototype?.onStageChange;
    ...
    BX.Crm.ItemDetailsComponent.prototype.onStageChange = function (...args) {
        ...
        const stage = args[0];
				...
				if (stageData.MESSAGE.length < 1) return originalOnStageChange.apply(this, args);
